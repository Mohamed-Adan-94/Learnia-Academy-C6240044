...
function registerStudent() {
    ...
    row.className =
        "grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-center items-center border rounded p-2 bg-white hover:bg-gray-200";

    row.innerHTML = `
    <span class="font-semibold">${registered + 1}</span>
    <span class="font-semibold">${name}</span>
    <span class="font-semibold">${course}</span>
    <button class="bg-red-500 text-white px-2 py-1 rounded font-semibold">Remove</button>
    `;
